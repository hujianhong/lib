...
package me.huding.lib.utils.hash;
...
public abstract class Hash {
   ...
   * @return one of the predefined constants
   */
  public static int getHashType(HashType hashType) {
    return parseHashType(hashType.toString());
  }
   ...
   */
  public static Hash getInstance(HashType hashType) {
    int type = getHashType(hashType);
